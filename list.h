...
EXT_LIST  listStatus  listInsertNodeData(head_t *head, uint32_t index, nodeData_t nodeData); //向线性表中指定节点之前插入一个元素
EXT_LIST  listStatus  listDeleteNodeData(head_t *head, uint32_t index, nodeData_t *nodeData);//从线性表中删除一个元素并取出删除元素第数据
